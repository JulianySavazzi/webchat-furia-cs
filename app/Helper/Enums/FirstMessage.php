...
{
    case init = 'ficar por dentro das novidades da FURIA CS no youtube, no X, e ver stats sobre as partidas';
    ...
    case instruction4 = 'Pode falar comigo que eu sempre respondo ;) ';
